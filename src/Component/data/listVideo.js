...
export const listvideo = [
    ...
    {id: 2, titre: 'Hitman', src: 'https://fr.web.img5.acsta.net/r_1280_720/medias/nmedia/18/64/61/90/18920333.jpg', synopsis: 'hitman est un tueur...', genre: 'action', date: '2030'},
    ...
    {id: 6, titre: 'Batman', src: batman, synopsis: 'Il y a un héro dans l\'ombre...', genre: 'action', date: '2020'},
    {id: 7, titre: 'WereWolf', src: 'https://www.nautiljon.com/images/asian-movie/00/29/a_werewolf_boy_1692.jpg', synopsis: 'Un étrange garçon vivant dans la...', genre: 'drama', date: '2015'},
    ...
    {id: 9, titre: 'Jumanji', src: 'https://cdn-s-www.estrepublicain.fr/images/ec8d4371-4cf7-446e-b80b-c6ecc9342c53/BES_06/illustration-jumanji-next-level_1-1577698367.jpg', synopsis: 'ils decouvrirent un jeu dans leur...', genre: 'aventure', date: '2020'},
    {id: 10, titre: 'Seigneur des anneaux', src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQjRfQVW19158aqB86-YaHm5irpfTffm3NEyvB2dmG0VGCJyWEO&usqp=CAU', synopsis: 'Un jeune garçon se retrouve...', genre: 'aventure', date: '2014'},
    {id: 11, titre: 'Avatar', src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQF_r6fnn_l8uGg9HFQF3vhskffRUB173jeaA9G6dRbBoZqKNRK&usqp=CAU', synopsis: 'A la découverte d\'une planète...', genre: 'aventure', date: '2010'}
]
